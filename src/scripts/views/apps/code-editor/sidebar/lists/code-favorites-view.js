/******************************************************************************\
|                                                                              |
|                             code-favorites-view.js                           |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a view used for showing a list of code favorites.        |
|                                                                              |
...
import FavoritesView from '../../../../../views/apps/code-editor/sidebar/favorites/favorites-view.js';

export default FavoritesView.extend({
	...
	initialize: function(options) {
		...
		//
		FavoritesView.prototype.initialize.call(this, options);
	...
	onOpen: function(item) {
		...
		//
		this.getParentView('app').openItems([item.model], {
