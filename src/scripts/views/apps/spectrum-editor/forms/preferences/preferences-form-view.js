...
import DisplayPrefsFormView from '../../../../../views/apps/spectrum-editor/forms/preferences/display-prefs-form-view.js';
import WindowPrefsFormView from '../../../../../views/apps/spectrum-editor/forms/preferences/window-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('spectrum_editor');
				break;
			case 'display':
