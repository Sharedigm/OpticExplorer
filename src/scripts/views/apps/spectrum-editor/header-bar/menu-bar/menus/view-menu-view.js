		...
		<li role="presentation" class="dropdown dropdown-submenu">
			...
			<ul class="show-sidebar-panels dropdown-menu" data-toggle="dropdown">
				<li role="presentation">
					<a class="show-spectra-panel"><i class="fa fa-check"></i><i class="fa fa-rainbow"></i>Spectra</a>
				</li>
		
				<li role="presentation">
					<a class="show-shared-panel"><i class="fa fa-check"></i><i class="fa fa-book"></i>Spectra Library</a>
				</li>			
			</ul>
		</li>
