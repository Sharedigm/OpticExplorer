...
import NavBarView from '../../../../views/apps/spectrum-editor/header-bar/nav-bar/nav-bar-view.js';
import MenuBarView from '../../../../views/apps/spectrum-editor/header-bar/menu-bar/menu-bar-view.js';
