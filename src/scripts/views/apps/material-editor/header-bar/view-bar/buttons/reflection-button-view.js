...
export default GroupedSelectButtonView.extend({
	...
	template: '<i class="fa fa-right-left"></i><span>Reflection</span>',
	...
	select: function(options) {
		...
		if (!options || !options.silent) {
			this.parent.parent.app.setOption('view_kind', 'reflection');
		}
	},
	...
	onLoad: function() {
		...
		let isReflective = material && material.isReflective();
		this.setEnabled(isEditable || isReflective);
	}
});