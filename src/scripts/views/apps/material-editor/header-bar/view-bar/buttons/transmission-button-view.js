...
export default GroupedSelectButtonView.extend({
	...
	template: '<i class="fa fa-arrows-up-to-line rotated"></i><span>Transmission</span>',
	...
	select: function(options) {
		...
		if (!options || !options.silent) {
			this.parent.parent.app.setOption('view_kind', 'transmission');
		}
	},
	...
	onLoad: function() {
		...
		let isTransmissive = material && material.isTransmissive();
		this.setEnabled(isEditable || isTransmissive);
	}
});