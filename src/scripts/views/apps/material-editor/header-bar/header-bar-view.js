...
import NavBarView from '../../../../views/apps/material-editor/header-bar/nav-bar/nav-bar-view.js';
import MenuBarView from '../../../../views/apps/material-editor/header-bar/menu-bar/menu-bar-view.js';
import ViewBarView from '../../../../views/apps/material-editor/header-bar/view-bar/view-bar-view.js';
