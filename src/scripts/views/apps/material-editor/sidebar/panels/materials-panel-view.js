...
export default SideBarPanelView.extend({
	...
	template: template(`
		<div class="header">
			<label><i class="fa fa-gem"></i>Materials</label>
		
			<div class="buttons">
				<button type="button" class="new-material success btn btn-sm" data-toggle="tooltip" title="New Material">
