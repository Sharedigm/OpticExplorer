/******************************************************************************\
|                                                                              |
|                            light-beam-form-view.js                           |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a form for specifying light beam attributes.             |
|                                                                              |
...
export default LightFormView.extend({
	...
	template: template(`
		...
		<div class="width form-group">
			...
			<div class="controls">
				<div class="input-group">
					<input type="number" class="required form-control" value="<%= width? width.val() : 0 %>">
					<div class="input-group-addon">
						<select class="units">
						<% for (let i = 0; i < length_units.length; i++) { %>
					...
					<div class="input-group-addon">
						<i class="active fa fa-question-circle" data-toggle="popover" data-placement="top" data-container="body" title="Width" data-content="This is the width of the beam."></i>
					</div>
				</div>
			</div>
		</div>
	...
	initialize: function() {
		...
		this.width = this.model.get('width') || new Units(10, 'mm');
