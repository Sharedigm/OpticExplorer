/******************************************************************************\
|                                                                              |
|                    show-perpendicular-axis-button-view.js                    |
|                                                                              |
|******************************************************************************|
|                                                                              |
...
export default ToggleButtonView.extend({
	...
	template: `
		<i class="rotated fa fa-arrows-left-right"></i>
	`,
	...
	activate: function() {
		...
		if (preferences.get('show_perpendicular_axis')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_perpendicular_axis', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_perpendicular_axis', false);
	}
});