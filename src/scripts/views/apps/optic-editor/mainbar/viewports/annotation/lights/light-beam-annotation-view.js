/******************************************************************************\
|                                                                              |
|                         light-beam-annotation-view.js                        |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a view for displaying annotations of light beams.        |
|                                                                              |
|******************************************************************************|
...
export default AnnotationView.extend({
	...
	className: 'light beam annotation',
		...
		return {
			...
			handle: new MarkerView({
				...
				ondrag: (point) => {
					...
					this.options.parent.setRotation(angle);
				}
			})
		}
	},
