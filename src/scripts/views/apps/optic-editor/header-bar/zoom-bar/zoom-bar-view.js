...
import ZoomInButtonView from '../../../../../views/apps/optic-editor/header-bar/zoom-bar/buttons/zoom-in-button-view.js';
import ZoomOutButtonView from '../../../../../views/apps/optic-editor/header-bar/zoom-bar/buttons/zoom-out-button-view.js';
import ZoomInputView from '../../../../../views/apps/optic-editor/header-bar/zoom-bar/inputs/zoom-input-view.js';
...
export default ToolbarView.extend({
	...
	template: template(`
		<div class="zoom-out hidden-xs" data-toggle="tooltip" title="Zoom Out" data-placement="bottom"></div>
		<div class="zoom-in hidden-xs" data-toggle="tooltip" title="Zoom In" data-placement="bottom"></div>
	...
	getZoomMode: function() {
		return this.parent.getChildView('zoom_mode').getValue();
	},
	...
	setZoomMode: function(zoomMode) {
		...
		this.getChildView('zoom_amount').setValue(zoom);
	...
	onLoad: function() {
		...
		// set initial zoom
		//
		this.setZoom(this.parent.parent.getZoom());
