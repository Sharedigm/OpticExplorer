...
export default SideBarPanelView.extend({
	...
	template: template(`
		<div class="header">
			<label><i class="fa fa fa-book"></i>Optics Library</label>
		
			<div class="buttons">
				<button type="button" class="open-shared success btn btn-sm" data-toggle="tooltip" title="Open Optics Library">
	...
	path: config.apps['optic_editor'].optics_directory,
