...
export default SideBarPanelView.extend({
	...
	template: template(`
		<div class="header">
			<label><i class="fa fa-database rotated flipped"></i>Optics</label>
		
			<div class="buttons">
				<button type="button" class="new-optic success btn btn-sm" data-toggle="tooltip" title="New Optic">
