...
export default SelectMenuView.extend({
	...
	enabled: function() {
		...
		return {
			'select-all': true,
			'select-none': hasSelectedMaterials,
			'select-invert': hasSelectedMaterials,
			'select-first': hasSelectedMaterials,
			'select-prev': hasSelectedMaterials,
			'select-next': hasSelectedMaterials,
			'select-last': hasSelectedMaterials,
			'select-before': hasSelectedMaterials,
			'select-after': hasSelectedMaterials
		};
	},
