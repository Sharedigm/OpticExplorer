...
export default ToggleButtonView.extend({
	...
	activate: function() {
		...
		if (preferences.get('show_labels')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_labels', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_labels', false);
	}
});