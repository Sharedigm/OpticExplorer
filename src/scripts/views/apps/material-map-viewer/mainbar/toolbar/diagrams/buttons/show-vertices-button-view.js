...
export default ToggleButtonView.extend({
	...
	activate: function() {
		...
		if (preferences.get('show_vertices')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_vertices', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_vertices', false);
	}
});