...
export default ToggleButtonView.extend({
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_edges', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_edges', false);
	}
});