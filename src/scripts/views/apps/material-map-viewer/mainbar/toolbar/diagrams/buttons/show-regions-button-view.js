...
export default ToggleButtonView.extend({
	...
	activate: function() {
		...
		if (preferences.get('show_regions')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_regions', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_regions', false);
	}
});