/******************************************************************************\
|                                                                              |
|                        show-index-axis-button-view.js                        |
|                                                                              |
|******************************************************************************|
|                                                                              |
...
export default ToggleButtonView.extend({
	...
	activate: function() {
		...
		if (preferences.get('show_index_axis')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_index_axis', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_index_axis', false);
	}
});