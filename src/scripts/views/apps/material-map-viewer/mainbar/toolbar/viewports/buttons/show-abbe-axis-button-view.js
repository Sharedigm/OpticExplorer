...
export default ToggleButtonView.extend({
	...
	activate: function() {
		...
		if (preferences.get('show_abbe_axis')) {
	...
	select: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_abbe_axis', true);
	},
	...
	deselect: function() {
		...
		// perform action
		//
		this.options.parent.app.setOption('show_abbe_axis', false);
	}
});