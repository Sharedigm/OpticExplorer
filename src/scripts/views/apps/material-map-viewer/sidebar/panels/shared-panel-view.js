...
export default SideBarPanelView.extend({
	...
	template: template(`
		<div class="header">
			<label><i class="fa fa-book"></i>Material Maps Library</label>
		
			<div class="buttons">
				<button type="button" class="open-shared-map success btn btn-sm" data-toggle="tooltip" title="Open Shared Material Map">
